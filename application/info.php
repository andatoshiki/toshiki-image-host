    ...
    <div class="col-md-12" style="padding-bottom: 10px;">
        <div class="col-md-6" style="padding-bottom: 10px;">
            <div class="input-group">
                ...
                <input type="text" class="form-control" id="markdown" value="![俊樹の圖床](<?php echo $img_url; ?>)">
        ...
        <div class="col-md-6" style="padding-bottom: 10px;">
            <div class="input-group">
                ...
                <input type="text" class="form-control" id="html" value='<img src="<?php echo $img_url; ?>" alt="俊樹の圖床" />'>
