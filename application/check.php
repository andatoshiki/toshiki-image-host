...
if (file_exists(APP_ROOT . '/config/toshiki.lock')) return; // 查询锁定弹窗文件是否存在
file_put_contents(APP_ROOT . '/config/toshiki.lock', '安装环境检测锁定文件,如需再次展示请删除此文件!', FILE_APPEND | LOCK_EX);
?>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    <i class="icon icon-heart"> </i>俊樹の圖床 安装环境检测
                </h4>
            </div>
...
<script>
    ...
    alert("初如果是第一次使用会打开环境检测配置哦~ 请耐心阅读~");
</script>