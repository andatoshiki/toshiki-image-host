    ...
    <div class="tab-content col-md-10 col-xs-8">
        ...
        <div class=" tab-pane fade" id="Content8">
            <div class="alert alert-primary">
                ...
                <a href="" target="_blank"><span class="label label-badge label-success" data-toggle="tooltip" title="浏览器插件">Chrome</span></a>
                <a href="" target="_blank"><span class="label label-badge label-success" data-toggle="tooltip" title="使用ShareX上传">ShareX</span></a>
                <a href="" target="_blank"><span class="label label-badge label-success" data-toggle="tooltip" title="使用PicGo上传">PicGo</span></a>
                <h6>图床依赖</h6>
                <p>
